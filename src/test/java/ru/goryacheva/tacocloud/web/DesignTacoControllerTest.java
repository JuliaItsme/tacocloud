...
import ru.goryacheva.tacocloud.web.DesignTacoController;
...
//        design.setIngredientRefs(Arrays.asList(new IngredientRef("FLTO"), new IngredientRef("GRBF"), new IngredientRef("CHED")));
    }
